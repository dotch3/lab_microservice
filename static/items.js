...
ns.model = (function() {
  ...
  return {
    ...
    create: function(liname, ldescription, lstatus, lidate, lfdate, lpname) {
      let ajax_options = {
        type: "POST",
        url: "api/usuarios",
        accepts: "application/json",
    ...
    update: function(liname, ldescription, lstatus, lidate, lfdate, lpname) {
      let ajax_options = {
        type: "PUT",
    ...
    delete: function(liname) {
      let ajax_options = {
        type: "DELETE",
        url: "api/usuarios/" + liname,
        accepts: "application/json",
