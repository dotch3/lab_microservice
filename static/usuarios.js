...
ns.model = (function() {
  ...
  return {
    read: function() {
      ...
      $.ajax(ajax_options)
        ...
        .fail(function(xhr, textStatus, errorThrown) {
          $event_pump.trigger("usuario_model_error", [
            xhr,
            textStatus,
            errorThrown,
          ]);
    ...
    create: function(lname, lsobr, lende, ltele, lemai, ltipo, luser, lpass) {
      let ajax_options = {
        type: "POST",
        url: "api/usuario",
        accepts: "application/json",
    ...
    delete: function(lname) {
      ...
      $.ajax(ajax_options)
        ...
        .fail(function(xhr, textStatus, errorThrown) {
          $event_pump.trigger("model_delete_success", [
            xhr,
            textStatus,
            errorThrown,
          ]);
...
ns.controller = (function(m, v) {
  ...
  $event_pump.on("usuario_model_error", function(
    e,
    xhr,
    textStatus,
    errorThrown
